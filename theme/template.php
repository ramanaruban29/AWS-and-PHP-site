...
<title>UOJ-Accommodations <?php echo $title; ?></title>
	    ...
	    <div class="navbar navbar-fixed-top navbar-inverse" style="background-color: darkblue" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>index.php"><b> UOJ-Accommodations </b></a>
	        </div>
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
	            <li><a href="<?php echo WEB_ROOT; ?>index.php"><b> Home </b></a></li>
	            <li><a href="<?php echo WEB_ROOT; ?>index.php?page=2"><b>Gallery</b></a></li>
	            <li><a href="<?php echo WEB_ROOT; ?>index.php?page=5"><b>Rooms and Rates </b></a></li>
	           <li><a href="<?php echo WEB_ROOT; ?>index.php?page=3"><b>About us</b></a></li> 
	            <li><a href="<?php echo WEB_ROOT; ?>index.php?page=4"><b>Contact us </b></a></li>
	            <li><a href="<?php echo WEB_ROOT; ?>index.php?page=7"><b> Site Map </b></a></li>
                <li><a href="<?php echo WEB_ROOT; ?>admin/login.php"><b> Admin Login </b></a></li> 				
...
<?php require_once $content;?>
	...
	<hr>
	     <footer>
        <p>&copy; UOJ-Accommodations.com </p>
