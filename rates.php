					...
					<div class="panel panel-default">
						<div class="panel-body">	
							<fieldset>
								...
								<legend><h2 class="text-left"><b> Rooms and their Rates</b></h2></legend>
						...
						echo '<div style="float:left; width:370px; margin-left:10px;">';
							echo '<div style="float:left; width:70px; margin-bottom:10px;">';				
					  			echo '<img src="'.$image .'" width="180px" height="150px" style="-webkit-border-radius:5px; -moz-border-radius:5px;"title="UOJ-Accommodation Rooms"/>';
							echo '</div>';	
						...
						echo '<input type="hidden" name="roomid" value="'.$result->roomNo.'"/>';
				  		echo '<p>  <strong> Owner Name: </strong> '.$result->roomName.'<br/><strong>Monthly Rental: </strong>Rs.'.$result->price.'
						<strong>Room Type: </strong>'.$result->typeName.'<br/> 
		  				<strong>No of beds: </strong> '.$result->Adults.' <br/><strong>  Contact No:</strong> 0'.$result->Children.'<br/></p>';
