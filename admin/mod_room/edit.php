		...
		<legend>Edit Room</legend>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <div class="col-md-8">
              <label class="col-md-4 control-label" for=
              "adult">No of Tenants:</label>

              <div class="col-md-8">
                <input class="form-control input-sm" id="adult" name="adult" placeholder=
									  "No of persons" type="text" value="<?php echo $result->Adults; ?>" onkeyup="javascript:checkNumber(this);">
              </div>
            </div>
          </div>
           ...
           <div class="form-group">
            <div class="col-md-8">
              <label class="col-md-4 control-label" for=
              "children">Contact no:</label>

              <div class="col-md-8">
                <input class="form-control input-sm" id="children" name="children" placeholder=
									  "Phone no" type="text" value="<?php echo $result->Children; ?>" onkeyup="javascript:checkNumber(this);">
              </div>
            </div>
          </div>
