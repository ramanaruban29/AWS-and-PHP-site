...
?>    <script type="text/javascript">
    ...
    $res = $user::AuthenticateUser($uname, $upass);
...
?>
 <button class="btn btn-lg btn-warning btn-block"   type="submit" name="btnback"> <a href="<?php echo WEB_ROOT; ?>index.php"> <i class="fa fa-home"></i><b> Home </b></a></button>
    
	<div class="container">

      <form class="form-signin" method="POST" action="login.php">
	    
        <h2 class="form-signin-heading"><b> Admin sign in Page</b></h2>
