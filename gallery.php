					...
					<div class="panel panel-default">
							...
							<div class="panel-body">	
								<div class="col-xs-12 col-sm-12">
									<fieldset>
										<legend><h2 class="text-left">Gallery Colection of Trending Accommodations</h2></legend>
										<?php 
											...
											foreach($cur as $amenity){
												...
												echo '<a href="'.$image.'" rel="prettyPhoto[mwaura]"><img src="'.$image.'" width="200px" height="120px" 
