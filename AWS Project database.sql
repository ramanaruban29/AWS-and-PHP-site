...
(8, 'Ramana\'s Hostel Rooms', 'Spacious place for better Accommodation Experience for all  Undergraduates. No of beds we have -03', 'pics/boarding (1).JPG'),
(9, 'Ramana\'s Hostel room interior', 'Luxury rooms with hot water showers. A/C available. No of chairs - 03, No of chairs- 06', 'pics/ramana.JPG'),
(10, 'Yaarl Hostels', 'Hostel type rooms for max accommodation. No of beds -20', 'pics/yarl.jpg'),
(11, 'Yaarl Hostel Rooms', 'Interior view of our room with available facilities. No of tables-20, No of chairs -40 available ', 'pics/yarl_inner.JPG'),
(17, 'Thilanka\'s Rental House', 'Front Entrance view of our house', 'pics/Thilanka.jpg'),
(6, 'Thilanka\'s House Hall', 'Fully furnished hall. No of beds-20, No of chairs -40, No of tables-20', 'pics/Thilanka_Hall.jpg');
...
(21, 'Rangan ', 'Ramanaurban', 'harini@gmail.com', '                '),
(22, 'Rangan ', 'Ramanaurban', 'harini@gmail.com', '                ');
...
(40, 'Rangan ', 'Ramanaruban', 'Srilanka', 'Jaffna', 'Meesalai', '40000', ' 0771192656', 'harini@gmail.com', 'harin@123');
...
(21, 5, 40, '2022-11-08', '2022-11-09', 1, 0, 75000, 'Confirmed', '0000-00-00', 'n50d5g3a'),
(22, 5, 40, '2022-11-08', '2022-11-09', 1, 0, 75000, 'Confirmed', '0000-00-00', '6vsmfmrn');
...
(2, 83, 'Rangan ', '15000', 6, 771192656, 'rooms/del1.jpg'),
(3, 82, 'Senthuran', '12000', 4, 771196325, 'rooms/Stan1.JPG'),
(5, 92, 'Thilanka', '75000', 40, 714569872, 'rooms/rent_house1.jpg'),
(8, 83, 'Rubee', '10000', 4, 778965412, 'rooms/dsc03102.jpg'),
(9, 92, 'Luxmi', '30000', 14, 112365897, 'rooms/rent_house_2.jpg'),
(10, 82, 'Ranjan', '100000', 40, 789654120, 'rooms/Capt.jpg');
...
(82, 'Hostel Rooms', 'These rooms are hostel type and each room has 4 bedrooms and 8 members can share a room. Other required Furnitures are fully equipped.'),
(83, 'Annexures', 'Tenant needs to share a house with the owner and tenant will get a portion of the house and other required facilities.'),
(92, 'Rental house', 'Tenants can share the entire house with any numbers of other tenants and pay the full monthly rental in advance in a collective manner. ');
...
(3, 'Rangan Ramanaruban', 'ramanan0910@gmail.com', 'ramana@123', 'Administrator'),
(4, 'Thilanka Jayasinghe', 'thilanka6@gmail.com', 'thilanka@123', 'Registrar'),
(5, 'Rangan Anishya', 'anish12@gmail.com', 'anish@123', 'Guest In-charge');
...
--
ALTER TABLE `guest`
  MODIFY `guest_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `room`
  MODIFY `roomNo` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `roomtype`
--
ALTER TABLE `roomtype`
  MODIFY `typeID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
